                  ...
                  <template v-for="field in currentStepFields" :key="field.form_field_id">
                    <div v-if="field.field_type === 'signature'">
                      <div class="flex items-center justify-between mb-1.5">
                        ...
                        <button type="button" @click="resetSignature(field.form_field_id)" class="flex items-center gap-1 text-[11px] text-[#999] active:text-[#FF7B22]">
...
function handleAutoFillInsured() {
  ...
  if (hasContractorStep.value) {
    ...
    autoFillFieldsFromUserDirect(targetFields, autoFillInsuredFromContractor.value)
  }
}
