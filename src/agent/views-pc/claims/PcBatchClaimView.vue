...
function handleAutoFillInsured() {
  const CODE_MAP: Record<string, string[]> = {
    ...
    CLAIMANT_NAME: ['INSURED_NAME', 'BENEFICIARY_NAME'],
    CLAIMANT_RRN: ['INSURED_RRN', 'BENEFICIARY_RRN'],
    CLAIMANT_RRN_FRONT: ['INSURED_RRN_FRONT', 'BENEFICIARY_RRN_FRONT'],
    CLAIMANT_RRN_BACK: ['INSURED_RRN_BACK', 'BENEFICIARY_RRN_BACK'],
    CLAIMANT_PHONE: ['INSURED_PHONE', 'BENEFICIARY_PHONE'],
    CLAIMANT_ADDRESS: ['INSURED_ADDRESS', 'BENEFICIARY_ADDRESS'],
    CLAIMANT_EMAIL: ['INSURED_EMAIL', 'BENEFICIARY_EMAIL'],
  }
