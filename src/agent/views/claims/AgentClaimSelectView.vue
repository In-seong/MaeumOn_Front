  ...
  <div class="min-h-screen bg-gradient-to-b from-[#FFF3ED] to-[#FFFFFF] flex justify-center">
    <div class="w-full max-w-[430px] min-h-screen relative bg-gradient-to-b from-[#FFF3ED] to-[#FFFFFF]">
      ...
      <main class="px-5 py-4 pb-28 overflow-y-auto" style="height: calc(100vh - 56px);">
        ...
        <section class="mb-5">
          ...
          >
            <button
              ...
              type="button"
              role="option"
              :aria-selected="selectedCustomerId === customer.customer_id"
          ...
          <!-- 빈 상태 -->
          <div
            v-else-if="!customerStore.loading"
        ...
        <!-- 2단계: 보험사 선택 (고객 선택 후 표시) -->
        <section v-if="selectedCustomerId" class="mb-5">
          <div class="flex items-center gap-2 mb-3">
            <span
              class="w-6 h-6 rounded-full text-[12px] font-bold flex items-center justify-center shrink-0"
        ...
        <section v-if="selectedCompanyId" class="mb-5">
          ...
          <div v-else class="flex flex-col gap-3">
            ...
            >
              ...
              <p v-if="form.form_description" class="text-[12px] text-[#999] mt-1">
                {{ form.form_description }}
              </p>
              <p v-if="form.form_fields_count" class="text-[11px] text-[#FF7B22] mt-2">
                입력 필드 {{ form.form_fields_count }}개
              </p>
            </button>
          </div>
        ...
        <div
          ...
          class="p-3 bg-[#FFE5E5] rounded-[8px] text-[13px] text-[#FF0000] mb-4"
          role="alert"
        >
          {{ claimStore.error }}
        </div>
