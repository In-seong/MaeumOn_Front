...
function iconBg(type: string): string {
  const map: Record<string, string> = {
    ...
    survey: 'bg-[#E5F7ED]',
    schedule: 'bg-[#F3E8FF]',
    ADMIN_MESSAGE: 'bg-[#FFF0E5]',
    NOTICE: 'bg-[#E8F0FE]',
    ASSIGNMENT: 'bg-[#E8F9EE]',
    system: 'bg-[#F5F5F5]',
  }
...
function iconSvg(type: string): string {
  const map: Record<string, string> = {
    ...
    ADMIN_MESSAGE: '<path d="M22 17H2a3 3 0 0 0 3-3V9a7 7 0 0 1 14 0v5a3 3 0 0 0 3 3zm-8.27 4a2 2 0 0 1-3.46 0"/>',
    NOTICE: '<path d="M22 17H2a3 3 0 0 0 3-3V9a7 7 0 0 1 14 0v5a3 3 0 0 0 3 3zm-8.27 4a2 2 0 0 1-3.46 0"/>',
    ASSIGNMENT: '<path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/>',
